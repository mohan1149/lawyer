...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('/lang/{lang}', 'DashBordController@setLanguage');
...
//---------------------setting court type--------------------------//
    ...
    Route::post('upload-document','CaseRunningController@uploadDocument');
    Route::get('delete/document/{id}','CaseRunningController@deleteDocument');
    ...
    Route::get('case/hearing/history/{id}','CaseRunningController@hearingHistory');
