        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <?php if(isset($permission)): ?>
                <li><a href="<?php echo e($permission ?? 'javascrip:void(0)'); ?>"><i
                            class="fa fa-key"></i>&nbsp;&nbsp;<?php echo e(__("t.permission")); ?></a></li>
            <?php endif; ?>
            ...
            <?php if(isset($print)): ?>
                <li class="divider"></li>
                <li><a target="_blank" href="<?php echo e($print); ?>"><i class="fa fa-print"></i>&nbsp;&nbsp;<?php echo e(__("t.print")); ?></a></li>
            <?php endif; ?>
            <?php if(isset($whatsapp)): ?>
                <li class="divider"></li>
                <li><a target="_blank" href="<?php echo e($whatsapp); ?>"><i class="fa fa-whatsapp"></i>&nbsp;&nbsp;<?php echo e(__("t.whatsapp")); ?></a></li>
            <?php endif; ?>
