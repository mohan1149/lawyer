...
<form  id="add_next_date" name="add_next_date" role="form" method="POST">
    ...
    <input type="hidden" id="business_on_date" name="business_on_date" value="<?php echo e($case->next_date); ?>"><div class="modal-body">
        <div class="alert alert-danger" style="display:none"></div>
        <?php

            if($case->is_nb =='No' && $case->is_active =='Yes'){ ?>
        ...
        <div class="row" style="margin-bottom:15px;">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> <?php echo e(__('t.case_status')); ?> <span class="text-danger">*</span></label>
                        <select class="form-control select2" id="case_status" name="case_status" style="width:100%;">
                            ...
                            <?php $__currentLoopData = $caseStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caseStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($case->is_active=='No' && ($caseStatus->case_status_name=='Disposed' || $caseStatus->case_status_name=='Closed' )){ continue;} ?>
                                <option value="<?php echo e($caseStatus->id); ?>" myvalue="<?php echo e($caseStatus->case_status_name); ?>" <?php echo e((!empty($case) && $case->case_status==$caseStatus->id && $case->is_active=='Yes')?'selected':''); ?>><?php echo e($caseStatus->case_status_name); ?></option>
        ...
        <div class="row" id="show_nextDate_div">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label  class="discount_text"> <?php echo e(__('t.next_date')); ?> <span class="text-danger">*</span></label>
        ...
        <div id="hide_decisiondate" style="display: none;">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="contct-info">
                        <div class="form-group">
                            <label  class="discount_text"> <?php echo e(__('t.decesion_date')); ?> <span class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="contct-info">
                        <div class="form-group">
                            <label  class="discount_text"><?php echo e(__('t.nature_of_disposal')); ?> <span class="text-danger">*</span></label>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label  class="discount_text"> <?php echo e(__('t.remarks')); ?> </label>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                    class="ik ik-x"></i><?php echo e(__('t.close')); ?></button>
        <button type="submit" name="case_next_date_btn" class="btn btn-success waves-effect waves-light"><?php echo e(__('t.save')); ?> <i class="fa fa-spinner fa-spin hide" id="btn_loader"></i></button>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.case_next_date').datepicker({
            ...
            modal: true,
            autoclose:true,
            startDate:"<?php echo e(date($date_format_laravel,strtotime($case->next_date. ' +1 day'))); ?>" });
        ...
        $("#add_next_date").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/case-next-date')); ?>",
                    method: "POST",
                    data: formData,
