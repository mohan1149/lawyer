...
class AppointmentController extends Controller
{
    ...
    public function appointmentList(Request $request)
    {
        ...
        $terms = DB::table('appointments AS a')
            ->leftJoin('advocate_clients AS ac', 'ac.id', '=', 'a.client_id')
            ->select('a.id AS id', 'a.is_active AS status', 'ac.mobile AS mobile', 'a.date AS date', 'a.name AS name', 'a.name AS appointment_name', 'ac.first_name AS first_name', 'ac.last_name AS last_name', 'a.client_id AS client_id', 'a.type As type', 'a.time AS time')
