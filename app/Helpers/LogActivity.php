...
class LogActivity
{
 ...
 public static function CheckuserType() {
		...
		if($court_cases > 0 && $countNotification > 0){
			...
			$noRecMsg .='<li>
							<a href="javascript:void(0);">
								<div class="mesge">
									<i class="fa fa-info fa-fw"></i>'.__("t.no_notification").'
								</div>
							</a>
						</li>';
		}
		...
		if($court_cases>0){
			$html .='<li>
						<a href="'.url('admin/dashboard').'">
							<div class="mesge">
							<i class="fa fa-gavel"></i>'.__("t.you_have_n_cases_today",['count'=>$court_cases]).'
							</div>
						</a>
					</li>';
		}
    ...
    public static function generateTasks()
    {
		...
		if (count($court_cases) > 0)
        {
			...
			$html .='<li>
						<a href="'.url('admin/case-running/').'">
							<div class="text-center link-block">
								<strong>'.__("t.view_all_tasks").'</strong> &nbsp; <i class="fa fa-angle-right"></i>
							</div>
						</a>
			...
			$html .='<li>
				<a href="javascript:void(0);">
					<div class="mesge">
						<i class="fa fa-info fa-fw"></i>'.__("t.no_pendding_cases").'
					</div>
				</a>
			</li>';
		}		
    ...
    {
        $taskArr = array(
            'not_started' => __('t.not_started'),
            'in_progress' => __('t.in_progress'),
            'completed' => __('t.completed'),
            'deferred' => __('t.deferred'),
