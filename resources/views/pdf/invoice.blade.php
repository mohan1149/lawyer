            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td width="75%" valign="top">
                        <h1 class="heading1" style="text-align: center;"><b>{{ $header['company_name'] ?? ""}}</b></h1>

                        <center>{{$header['address'].',' ?? ''}} {{$header["city"] }} {{" - ".$header["pincode"].',' ?? ''}}  {{$header["state"].',' ?? '' }}  {{ $header["country"] ?? '' }}  </center>
                    </td>
                </tr>
            </table>
        </td>
