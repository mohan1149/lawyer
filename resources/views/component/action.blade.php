        ...
        <ul class="dropdown-menu" role="menu">
            ...
            @if(isset($permission))
                <li><a href="{{ $permission ?? 'javascrip:void(0)' }}"><i
                            class="fa fa-key"></i>&nbsp;&nbsp;{{__("t.permission")}}</a></li>
            @endif
            ...
            @if (isset($print))
                <li class="divider"></li>
                <li><a target="_blank" href="{{ $print }}"><i class="fa fa-print"></i>&nbsp;&nbsp;{{__("t.print")}}</a></li>
            @endif
            @if (isset($whatsapp))
                <li class="divider"></li>
                <li><a target="_blank" href="{{ $whatsapp }}"><i class="fa fa-whatsapp"></i>&nbsp;&nbsp;{{__("t.whatsapp")}}</a></li>
            @endif
