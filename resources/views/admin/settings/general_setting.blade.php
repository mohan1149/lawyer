                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="invoice_prefex">{{__("t.company_name")}} <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="invoice_number">{{__("t.address")}} <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="invoice_number">{{__("t.country")}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="invoice_number">{{__("t.state")}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="invoice_number">{{__("t.city")}} <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="invoice_number">{{__("t.pin_code")}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <div class="valfavicon">
                                    <label for="invoice_number">{{__("t.favicon")}} </label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <div class="vallogo">
                                    ...
                                    <label for="invoice_number">{{__("t.logo")}} </label>
