        ...
        <form action="{{route('court.update',$court->id)}}" method="POST" id="tagForm" name="tagForm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">{{__("t.edit_court")}}</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_type">{{__("t.court_type")}} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_subtype">{{__("t.court")}} <span class="text-danger">*</span></label>
