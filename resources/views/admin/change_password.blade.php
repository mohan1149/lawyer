                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        ...
                                        <form id="change_password" name="change_password" role="form" method="POST"
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    <label for="current_password">{{__("t.current_password")}} <span
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    <label for="new_password">{{__("t.new_password")}} <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    <label for="confirm_password">{{__("t.confirm_password")}} <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group pull-right">
                                                <div class="col-md-12 col-sm-6 col-xs-12">
                                                    ...
                                                    <button type="submit" name="btn_add_change" class="btn btn-success">
                                                        <i class="fa fa-save" id="show_loader"></i>&nbsp;{{__("t.update")}}
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
