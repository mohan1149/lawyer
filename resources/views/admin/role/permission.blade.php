                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <table class="table">
                        <thead>
                          <tr>
                            <th width="30%">{{__("t.menu")}}</th>
                            <th width="30%">{{__("t.sub_menu")}}</th>

                            <th width="10%"><input class="all_view" type="checkbox">&nbsp; {{__("t.view")}} </th>
                            <th width="10%"> <input class="all_add" type="checkbox">&nbsp; {{__("t.add")}}</th>
                            <th width="10%"> <input class="all_edit" type="checkbox">&nbsp; {{__("t.edit")}}</th>
                            <th width="10%"> <input class="all_delete" type="checkbox">&nbsp; {{__("t.delete")}}</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr class="tr_permition">
                            <td>{{__("t.dashboard")}}</td>
                   ...
                   <div class="form-group pull-right">
                        <div class="col-md-12 col-sm-6 col-xs-12">
                          <a href="{{ route('role.index')  }}" class="btn btn-danger">{{__("t.cancel")}}</a>

                          <button type="submit" class="btn btn-success"><i class="fa fa-save" id="show_loader"></i>&nbsp;{{__("t.save")}}</button>
                        </div>
                  </div>
                </form>
              </div>
