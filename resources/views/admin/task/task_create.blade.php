                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.subject")}} <span class="text-danger">*</span></label>
                                <input type="text" placeholder="" class="form-control" id="task_subject"
                                       name="task_subject">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.start_date")}} <span class="text-danger">*</span></label>
                                <input type="text" placeholder="" class="form-control dateFrom" id="start_date"
                                       name="start_date" readonly="">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.deadline")}}<span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.select_status")}}: <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.priority")}} <span class="text-danger">*</span></label>
                                <select class="form-control" id="priority" name="priority">
                                    <option value="">{{__("t.select_priority")}}</option>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.assign_to")}}<span class="text-danger">*</span></label>

                                <select multiple class="form-control" id="assigned_to" name="assigned_to[]">
                                    <option value="">{{__("t.select_user")}}</option>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.related_to")}}</label>
                                <select class="form-control selct2-width-100" id="related" name="related">
                                    <option value="">{{__("t.nothing_selected")}}</option>
                                    <option value="case">{{__("t.case")}}</option>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group task_selection hide">
                                <label for="fullname">{{__("t.case")}}</label>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.description")}}:</label>
                        ...
                        <div class="form-group pull-right">
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <a class="btn btn-danger" href="{{ route('tasks.index') }}">{{__("t.cancel")}}</a>
