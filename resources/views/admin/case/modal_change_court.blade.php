...
<form id="case_transfer" name="case_transfer" role="form" method="POST" action="{{ url('admin/transferCaseCourt')}}">
    ...
    <div class="modal-body">
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> {{__('t.court_number')}} <span class="text-danger">*</span></label>
        ...
        <div class="row change-m-bottom">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> {{__('t.judge_type')}}<span class="text-danger">*</span></label>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> {{__('t.judge_name')}}</label>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> {{__('t.transfer_date')}} <span class="text-danger">*</span></label>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" name="case_transfer_btn" class="btn btn-success waves-effect waves-light">{{__('t.save')}} <i
