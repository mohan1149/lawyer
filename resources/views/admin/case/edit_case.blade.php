                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input  value={{$case->ctitle}} type="text" class="form-control" name="ctitle" id="ctitle" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="radio" id="test1" name="position"
                                       value="Petitioner" {{(!empty($case) && $case->client_position=='Petitioner')?'checked':''}}>&nbsp;&nbsp;{{__('t.petitioner')}}
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="test2" name="position"
                                       value="Respondent" {{(!empty($case) && $case->client_position=='Respondent')?'checked':''}}>&nbsp;&nbsp;{{__('t.respondent')}}
                            </div>
                        </div>
