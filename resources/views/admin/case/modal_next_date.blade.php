...
<form  id="add_next_date" name="add_next_date" role="form" method="POST">
    ...
    <input type="hidden" id="business_on_date" name="business_on_date" value="{{$case->next_date}}"><div class="modal-body">
        ...
        <div class="row" style="margin-bottom:15px;">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> {{__('t.case_status')}} <span class="text-danger">*</span></label>
        ...
        <div id="hide_decisiondate" style="display: none;">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="contct-info">
                        <div class="form-group">
                            <label  class="discount_text"> {{__('t.decesion_date')}} <span class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="contct-info">
                        <div class="form-group">
                            <label  class="discount_text">{{__('t.nature_of_disposal')}} <span class="text-danger">*</span></label>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label  class="discount_text"> {{__('t.remarks')}} </label>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                    class="ik ik-x"></i>{{__('t.close')}}</button>
        <button type="submit" name="case_next_date_btn" class="btn btn-success waves-effect waves-light">{{__('t.save')}} <i class="fa fa-spinner fa-spin hide" id="btn_loader"></i></button>
