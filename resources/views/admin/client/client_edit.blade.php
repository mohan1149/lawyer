                ...
                <form id="edit_client_form" name="edit_client_form" role="form" method="POST"
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="m_name">{{__("t.middle_name")}} <span class="text-danger">*</span></label>
                                <input type="text" placeholder="" class="form-control" id="m_name" name="m_name"
                                       value="{{ $client->middle_name ?? ''}}">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.last_name")}} <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.gender")}} <span class="text-danger">*</span></label><br>
                                ...
                                <input type="radio" name="gender" id="genderF"
                                       value="Female" {{ (!empty($client->gender) && $client->gender =='Female') ? "checked" : "" }}/>&nbsp;&nbsp;{{__("t.female")}}
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.email")}}</label>
                                <input type="text" value="{{ $client->email ?? ''}}" placeholder="" class="form-control"
                                       id="email" name="email">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.mobile_no")}}. <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.alternate_no")}}.</label>
                                <input type="text" value="{{ $client->alternate_no ?? ''}}" placeholder=""
                                       class="form-control" id="alternate_no" name="alternate_no">
                            </div>
                            <div class="col-md-9 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.address")}} <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.country")}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.state")}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.city")}} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <br>
                            <input type="checkbox" value="Yes" name="change_court_chk" id="change_court_chk">{{__("t.add_more")}}
                            person
                            <br/>
                        ...
                        <div id="change_court_div" class="hidden">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label for="fullname">{{__("t.client")}} <span class="text-danger">*</span></label><br>
                                    <br>
                                    <input type="radio" name="type" id="test6"
                                           value="single" {{ (!empty($client->client_type) && $client->client_type =='single') ? "checked" : "" }} />
                                    &nbsp;&nbsp;{{__("t.single_advocate")}}:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="type" id="test7"
                                           value="multiple" {{ (!empty($client->client_type) && $client->client_type =='multiple') ? "checked" : "" }} />&nbsp;&nbsp;{{__("t.multiple_advocate")}}
                                ...
                                <div data-repeater-list="group-a">
                                        ...
                                        @foreach($client_parties_invoive as $key=> $value)
                                            <div data-repeater-item>
                                                <div class="row border-addmore">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        <label for="fullname">{{__("t.first_name")}} <span
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        <label for="fullname">{{__("t.middle_name")}}<span
                                                                    class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        <label for="fullname">{{__("t.last_name")}} <span
                                                                    class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        <label for="fullname">{{__("t.mobile_no")}}. <span
                                                                    class="text-danger">*</span></label>
                                    ...
                                    @else
                                        <div data-repeater-item>
                                            <div class="row border-addmore">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                    <label for="fullname">{{__("t.first_name")}} <span class="text-danger">*</span></label>
                                                    <input type="text" id="firstname" name="firstname"
                                                           data-rule-required="true"
                                                           data-msg-required="Please enter first name."
                                                           class="form-control">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                    <label for="fullname">{{__("t.middle_name")}} <span class="text-danger">*</span></label>
                                                    <input type="text" id="middlename" name="middlename"
                                                           data-rule-required="true"
                                                           data-msg-required="Please enter middle name."
                                                           class="form-control">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                    <label for="fullname">{{__("t.address")}} <span
                                                                class="text-danger">*</span></label>
                                                    <input type="text" id="address_client" name="address_client"
                                                           data-rule-required="true"
                                                           data-msg-required="Please enter address."
                                        ...
                                        @foreach($client_parties_invoive as $key=> $value)
                                            <div data-repeater-item>
                                                <div class="row border-addmore">
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        <label for="fullname">{{__("t.advocate_name")}}. <span
                                                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group pull-right">
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <a href="{{ route('clients.index')  }}" class="btn btn-danger">{{__("t.cancel")}}</a>
