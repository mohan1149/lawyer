                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="radio" name="gender" id="genderM" value="Male" checked="" required/> &nbsp;&nbsp;{{__("t.male")}}:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="gender" id="genderF" value="Female"/>&nbsp;&nbsp;{{__("t.female")}}
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">{{__("t.email")}}<span class="text-danger">*</span></label>
                        ...
                        <div id="change_court_div" class="hidden">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <input type="radio" name="type" id="test7" value="multiple"/>&nbsp;&nbsp;{{__("t.multiple_advocate")}}
                                ...
                                <div data-repeater-list="group-b">
                                    <div data-repeater-item>
                                        ...
                                        >
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                <label for="fullname">{{__("t.advocate_name")}}. <span class="text-danger">*</span></label>
