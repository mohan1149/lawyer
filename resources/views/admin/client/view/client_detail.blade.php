...
@section('content')
    ...
    <div class="row">
                                ...
                                @foreach($single as $s)
                                    <div class="col-md-6 hidden-small">
                                        ...
                                        <table class="countries_list">
                                            ...
                                            <tr>
                                                <td>{{__("t.mobile")}} :- {{ $s->party_mobile}}</td>

                                            </tr>
                                            <tr>
                                                <td>{{__("t.address")}} :-{{ $s->party_address}}</td>

                                            </tr>
                                            @if($client->client_type=="multiple")
                                                <tr>
                                                    <td>{{__("t.advocate")}}:-{{ $s->party_advocate}}</td>
        ...
        <div class="col-md-12">
		<h2>{{ __("t.user_documents") }} </h2>
                @include('admin.client.view.docs',$docs)
	</div>
    </div>
@endsection
