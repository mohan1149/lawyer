                        ...
                        <div class="col-md-12">
                            <div class="right-part-bg-all">
                                <div class="ctzn-usrs">
                                    ...
                                    <h1 class="text-center">{{__("t.expense")}} </h1>

                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="invoice-title">
                                                <h3 class="pull-right">{{__("t.bill_no")}}: {{ $invoice_no ?? ''}}</h3>
                                            </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-condensed">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left"><strong>{{__("t.items")}}</strong></td>
                                                                ...
                                                                @if($tax_type!="")
                                                                    <td class="text-center" width="10%"><strong>{{__("t.tax_per")}}
                                                                            (%)</strong></td>
                                                                    <td class="text-center" width="10%"><strong>{{__("t.tax")}}
                                                                            (Amt)</strong></td>
                                                                @endif
                                                                <td class="text-center" width="10%">
