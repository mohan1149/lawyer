                    ...
                    <form id="add_user" name="add_user" role="form" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                                ...
                                                @if($users->profile_img!='')
                                                    ...
                                                    <label id="remove_crop">
                                                        <input type="checkbox" value="Yes" name="is_remove_image"
                                                               id="is_remove_image">&nbsp; {{__("t.remove_feature_image")}} .</label>
                                                @else
                                        ...
                                        <span class="fa fa-upload text-center font-15"><span
                                                class="set-profile-picture"> &nbsp;  {{__("t.set_profile_image")}}  </span>
                                        </span>
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        <input type="checkbox" id="chk_pass" name="chk_pass" value="yes"> {{__("t.change_password")}}
