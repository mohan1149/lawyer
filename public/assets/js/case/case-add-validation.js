...
jQuery(document).ready(function () {
    ...
    $('input[type=radio][name=position]').on('change', function () {
        if (this.value == 'Respondent') {
            $('.position_name').html('Petitioner Name/اسم المدعي  ');
            $('.position_advo').html('Petitioner Advocate/محامي المدعي');
        } else if (this.value == 'Petitioner') {
            $('.position_name').html('Respondent Name/اسم المدعي عليه ');
            $('.position_advo').html('Respondent Advocate/محامي المدعي عليه');
        }
    });
