...
jQuery(document).ready(function () {
    ...
    $(document.body).on("change", ".services", function () {
        ...
        $(this).closest('tr').find('input.rate').val(parseFloat(Myservices).toFixed(3)).trigger('keyup');
        $('.tax').trigger('change');
    ...
    $(document).on('keyup', '.qty , .rate', function () {
        ...
        $(this).closest('tr').find('input.amount').val(price.toFixed(3));
        ...
        if (myTax != "") {
            ...
            $("#taxVal").val(parseFloat(g).toFixed(3));
            g = roundToTwo(parseFloat(g) + parseFloat(subTotal));

            $("#grandTotal").val(g.toFixed(3));
        } else {
            $("#taxVal").val("0.000");
            $("#grandTotal").val(subTotal.toFixed(3));
        }
